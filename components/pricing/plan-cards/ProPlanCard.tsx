...
export default function ProPlanCard({
  ...
  return (
    <div className="glass-card rounded-2xl flex flex-col w-full border border-border/20 overflow-hidden">
      {/* Card Header */}
      <div className="p-6 border-b border-border/20 bg-gradient-to-r from-gray-800 to-black">
      ...
      <div className="p-6 border-t border-border/20">
        <Link
          href="/contact-sales"
          className="w-full block text-center py-3 rounded-lg"
          style={{
            background: 'linear-gradient(135deg, var(--accent), #7a43b8)',
            color: 'white',
            fontWeight: '500',
